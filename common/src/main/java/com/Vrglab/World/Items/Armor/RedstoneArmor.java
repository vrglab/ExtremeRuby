...
import com.Vrglab.World.Items.Armor.Models.RedstoneArmorModel;
...
public class RedstoneArmor extends AzureArmor {
    public RedstoneArmor(ArmorMaterial armorMaterial, Type type, Properties properties) {
