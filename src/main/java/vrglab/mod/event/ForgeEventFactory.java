...
public class ForgeEventFactory
{
    ...
    @Nullable
    public static CapabilityDispatcher gatherCapabilities(TileEntity village)
    {
        return gatherCapabilities(new AttachCapabilitiesEvent<TileEntity>(TileEntity.class, village), null);
    }
	...
	public static CapabilityDispatcher gatherCapabilities(vrglab.mod.village.Village village) {
