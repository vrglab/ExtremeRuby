...
public class BlockCrusher extends BlockBase implements ITileEntityProvider
{
    ...
    public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) 
...

   	{
   		...
   		if(active) worldIn.setBlockState(pos, BlockInit.CRUSHER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, true), 3);

   		else worldIn.setBlockState(pos, BlockInit.CRUSHER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(BURNING, false), 3);
