...

{
...

	{
		...
		return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.crasher");
	...
	{	
...

		{
...

			{
				...
				ItemStack output = CrusherRecipes.getInstance().getSinteringResult(inputs[0], inputs[1]);
...

	{
...

		{
			...
			ItemStack result = CrusherRecipes.getInstance().getSinteringResult((ItemStack)this.handler.getStackInSlot(0), (ItemStack)this.handler.getStackInSlot(1));	
